 ...
 */
package hr.tstrelar.flight.frontend.api;
...
public interface FlightApi {
    ...
    ResponseEntity<FlightDto> addFlight(@ApiParam(value = "A flight information that needs to be added to the repo", required = true) @Valid @RequestBody FlightDto body);
